<div class="about-header">
  <img src="assets/profile.jpeg" alt="Portrait of Piyush" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Hi I'm Piyush</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">
  <a href="https://scholar.google.com/citations?user=MYYc_SEAAAAJ&hl=en" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://github.com/piyushgaikwad" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://dev.to/piyushgaikwaad" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" style="width:20px;height:20px;opacity:0.9;" xmlns="http://www.w3.org/2000/svg"><path d="M3 4h18v16H3V4zm5 4H6v8h2c1.66 0 3-1.34 3-3v-2c0-1.66-1.34-3-3-3zm6 0h-2v8h2c1.66 0 3-1.34 3-3v-2c0-1.66-1.34-3-3-3zm4 0h-2v8h2V8z"></path></svg>
  <span>Dev.to</span>
  </a>

  <a href="https://www.linkedin.com/in/piyushgaikwad/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:piyushgaikwad321@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
<b>📄 Recent Research</b>
  ...
  <p>
    <b>AI Commit Ledger: Bridging the AI Transparency Gap in Version Control with Deterministic Session Attribution</b><br>
    Published in <i>IJARSCT</i>, Vol. 6, Issue 3, March 2026<br>
    DOI: <a href="https://doi.org/10.48175/IJARSCT-31627">10.48175/IJARSCT-31627</a><br>
    <a href="https://www.researchgate.net/publication/402524035_AI_Commit_Ledger_Bridging_the_AI_Transparency_Gap_in_Version_Control_with_Deterministic_Session_Attribution">Read on ResearchGate</a> ·
    <a href="https://ijarsct.co.in/Paper31627.pdf">PDF</a>
  </p>
